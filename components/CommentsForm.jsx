...
const CommentsForm = ({slug,setProgress}) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      <h3 className="text-xl mb-8 font-semibold border-b pb-4">Post your comment</h3>
    ...
    <div className="mt-8">
      ...
      className="transaction duration-500 ease hover:bg-indigo-900 inline-block bg-pink-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer"
      >
        Post Comment
      </button>
